...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/users/list', title: 'Users', icon:'ni-single-02 text-primary', class: '', type: 1 },
    { path: '/roles/list', title: 'Roles', icon:'ni-badge text-info', class: '', type: 1},
    { path: '/permissions/list', title: 'Permissions', icon:'ni-key-25 text-success', class: '', type: 1},
    { path: '/user-roles/list', title: 'User-Roles', icon:'ni-hat-3 text-warning', class: '', type: 1},
];
